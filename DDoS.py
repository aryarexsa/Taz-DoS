version="1.0"
class color:
    HEADER = '\033[0m, \e[1;36m, \e[1;31m'

logo = color.HEADER + '''

____________________   _____		_______________					  _ _ __		  _ _ _ _ _   _ _ _ _ _ _ _
|                   | /	    \	   |              /					  |     )_       /         \  |			    |
|_______     _______|/	     \	   |_______      /					  |       |_    /  _ _ _ _ 	\ |      _ _ _ _|
	    |    |      /	 __	  \			  /     /     ______________  |         )_ /  /	      \  \|     |
	    |    |     /    /  \   \         /     /     |______________| |           |	 |		   |  |		|_ _ _ _
	    |    |    /	   /____\   \	    /     /						  |			 _|	 |		   |  |				|
	    |    |   /	    ____	 \	   /     /_____					  |			_) \  \	_ _ _ /  /|________	    |
	    |    |  /	   |	|     \	  /            |				  |       _|	\			/		   |    |
	    |____| /_______|	|______\ /_____________|				  | _ _ __|		 \_________/   _ _ _ _ |    |
																								  |				|
																								  |_____________|
...
import os, sys, signal, httplib, urlparse, json, time, string
import sys
import json
import time
import string
